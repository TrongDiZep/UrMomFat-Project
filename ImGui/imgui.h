...
namespace ImGui
{
    ...
    IMGUI_API ImVec2        CalcTextSize2(const char* text, const float textSize = -1.0f, const char* text_end = NULL, bool hide_text_after_double_hash = false, float wrap_width = -1.0f);
